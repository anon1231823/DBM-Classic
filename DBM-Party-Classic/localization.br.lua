...
L:SetGeneralLocalization{
	name 		= "Suprema Interrogadora Gerstahn"
}
-----------------
-- Lord Roccor --
-----------------
...
L:SetGeneralLocalization{
	name 		= "Mestre de Matilha Grebmar"
}
---------------------------------------------------------
-- Ring of Law --
---------------------------------------------------------
...
L:SetGeneralLocalization{
	name 		= "Imperador Dagran Thaurissan"
}
...
L:SetGeneralLocalization{
	name 		= "Caçadora Sombria Vosh'gajin"
}
-----------------------------
--  War Master Voone  --
-----------------------------
...
L:SetGeneralLocalization{
	name 		= "Alto-inquisidor Fairbanks"
}
...
L:SetGeneralLocalization{
	name 		= "Mestre de Canhões Gualter"
}
