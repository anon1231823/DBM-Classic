...
L:SetOptionLocalization({
	...
	WarningWaveSoon		= "Mostrar aviso prévio para a próxima onda de lacaios",
	WarningWaveSpawned	= "Mostrar aviso quando uma onda de lacaios começar",
	WarningRiderDown	= "Mostrar aviso quando um Cavalgante Implacável morre",
	WarningKnightDown	= "Mostrar aviso quando um Cavaleiro da Morte Implacável morre"
})
...
L:SetOptionLocalization({
	WarningMarkSoon				= "Mostrar aviso prévio para marcas",
	WarningMarkNow				= "Mostrar aviso para marcas",
	SpecialWarningMarkOnPlayer	= "Mostrar um aviso especial quando você for afetado por mais de quatro marcas"
})
...
L:SetOptionLocalization({
	WarningAirPhaseSoon	= "Mostrar aviso prévio para mudança de fase de ar",
	WarningAirPhaseNow	= "Anunciar mudança para fase de ar",
	WarningLanded		= "Anunciar mudança de fase no solo",
	TimerAir			= "Mostrar cronômetro para mudança para fase de ar",
	TimerLanding		= "Mostrar cronômetro para mudança de fase no terra",
	TimerIceBlast		= "Mostrar cronômetro para $spell:28524",
...
L:SetOptionLocalization({
	TimerPhase2			= "Mostrar cronômetro para mudar para a Fase 2",
	specwarnP2Soon		= "Mostrar aviso especial 10 s antes de mudar para a Fase 2",
	warnAddsSoon		= "Mostrar aviso prévio para quando os Guardiões da Coroa de Gelo aparecerem"
})
