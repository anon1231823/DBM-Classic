...
L.YOUR_VERSION_OUTDATED      = "Tu versión de " .. L.DEADLY_BOSS_MODS .. " está desfasada. Por favor, visita Curse/Twitch, WoWI, o la página de Github para descargar la última versión."
...
L.UPDATEREMINDER_HEADER			= "Tu versión de " .. L.DEADLY_BOSS_MODS .. " está desfasada.\nPuedes descargar la versión %s (%s) a través de Curse/Twitch, WoWInterface o la página de Github."
