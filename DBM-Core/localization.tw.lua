...
L.LOAD_MOD_SUCCESS			= "成功載入%s模組。輸入/dbm 可自訂警告音效和個人化註記。"
L.LOAD_MOD_COMBAT			= "延遲載入'%s'直到離開戰鬥"
L.LOAD_GUI_ERROR				= "無法載入圖形介面：%s"
L.LOAD_GUI_COMBAT			= "圖形介面不能在戰鬥中初始化。圖形介面將在脫離戰鬥後自動開啟，這樣就能夠再次在戰鬥中使用。"
L.BAD_LOAD					= L.DBM .. "偵測到你的此副本的模組在戰鬥中讀取失敗。一旦脫離戰鬥，請立即輸入/console reloadui重新載入。"
L.LOAD_MOD_VER_MISMATCH		= "%s不能被讀取因為你的" .. L.DBM .. "-Core未達需求，請更新版本。"
L.LOAD_MOD_EXP_MISMATCH		= "%s不能被讀取因為這是設計給WoW資料片而目前尚未開放。當資料片開放時，此模組會自動啟用。"
L.LOAD_MOD_TOC_MISMATCH		= "%s不能被讀取因為這不是設計給經典版WoW。您像是安裝了正式版的模組。請移除此模組並僅使用為經典版魔獸世界設計的插件。"
...
L.MOVIE_SKIPPED				= L.DBM .. "已嘗試自動略過場動畫。"

L.AFK_WARNING				= "你正在暫離並戰鬥中(血量還剩餘%d百分比)所以發出警告。如果你並非暫離，請清除暫離的標籤或是在'額外功能'停用此選項。"

L.COMBAT_STARTED_AI_TIMER	= "我的CPU是類神經網路處理器，一種學習型電腦。(此戰鬥會使用新的AI計時器功能去產生計時器的近似值)"

L.PROFILE_NOT_FOUND			= "<DBM>你目前的配置檔已經損毀。DBM會載入'Default'配置檔。"
...
L.DPMCORE							= "警告：Deadly PvP 模組已經停止更新而且不相容此版本的DBM。請移除避免衝突。"
L.DBMLDB							= "警告：DBM-LDB已經內建在DBM-Core，建議從你的addons資料夾中移除DBM-LDB。"
...
L.OUT_OF_DATE_NAG				= "你的" .. L.DEADLY_BOSS_MODS .. "版本已經過期你設定忽略彈出更新提示。還是建議你更新避免缺少一些重要的警告或是計時器，而其他人也看不到從你發出的大喊警告。"
L.CLASSIC_ONLY					= "警告: 此版本的" .. L.DBM .. "僅適用於經典版魔獸世界。反安裝此版本並為正式版魔獸世界安裝正確的" .. L.DBM .. "版本。"
...
L.MINIMAP_TOOLTIP_FOOTER		= "按住shift即可拖放移動"

L.RANGECHECK_HEADER			= "距離監視(%d碼)"
L.RANGECHECK_HEADERT			= "距離監視(%d碼-%d人)"
L.RANGECHECK_RHEADER			= "反距離監視(%d碼)"
L.RANGECHECK_RHEADERT		= "反距離監視(%d碼-%d人)"
...
L.RANGERADAR_HEADER			= "距離:%d 玩家:%d"
L.RANGERADAR_RHEADER			= "反距離:%d 玩家:%d"
...
L.INFOFRAME_ALT				= "次要能量:"--Alternate Power
...
L.BREAK_USAGE				= "休息時間不能長於60分鐘。請確定你輸入的時間是分鐘不是秒。"
L.BREAK_START				= "現在開始休息-你有%s分鐘!"
L.BREAK_MIN					= "%s分鐘後休息時間結束!"
L.BREAK_SEC					= "%s秒後休息時間結束!"
L.TIMER_BREAK				= "休息時間!"
L.ANNOUNCE_BREAK_OVER		= "休息時間結束於%s"

L.TIMER_PULL					= "戰鬥準備"
L.ANNOUNCE_PULL				= "%d秒後拉怪 (%s發起)"
L.ANNOUNCE_PULL_NOW			= "拉怪囉!"
L.ANNOUNCE_PULL_TARGET		= "開打%s在%d秒後 (%s發起)"
L.ANNOUNCE_PULL_NOW_TARGET	= "開打%s!"
...
L.AUTO_ANNOUNCE_TEXTS.targetsource	= ">%%s<對>%%s<施放了%s"
...
L.AUTO_ANNOUNCE_TEXTS.countdown		= "%s再%%ds"
...
local prewarnOption 				= "顯示$spell:%s的預先警告"
...
L.AUTO_ANNOUNCE_OPTIONS.countdown	= "預先警告：$spell:%s的倒數"
...
L.AUTO_ANNOUNCE_OPTIONS.stagechange	= "警告：階段轉換"
L.AUTO_ANNOUNCE_OPTIONS.prestage			= "預先警告：第%s階段"
...
L.AUTO_SPEC_WARN_TEXTS.youpos		= "你中了%s (站位：%%s)"
L.AUTO_SPEC_WARN_TEXTS.soakpos		= "%s - 快到%%s踩圈分擔"
...
L.AUTO_SPEC_WARN_TEXTS.dodgeloc		= "%s - 閃避%%s"
...
L.AUTO_SPEC_WARN_TEXTS.lookaway		= "%%s中了%s - 快轉身"
...
L.AUTO_SPEC_WARN_TEXTS.gtfo			= "注意%%s - 快移動"
L.AUTO_SPEC_WARN_TEXTS.adds			= "小怪來了 - 快更換目標!"
L.AUTO_SPEC_WARN_TEXTS.addscustom	= "小怪來了 - %%s"
L.AUTO_SPEC_WARN_TEXTS.targetchange	= "目標改變 - 快更換至%%s"
...
L.AUTO_TIMER_TEXTS.cdspecialshort	= "~特別"
...
L.AUTO_TIMER_TEXTS.nextspecialshort= "特別"
L.AUTO_TIMER_TEXTS.achievement		= "%s"
L.AUTO_TIMER_TEXTS.stage				= "下一個階段"
L.AUTO_TIMER_TEXTS.stageshort		= "階段"
L.AUTO_TIMER_TEXTS.adds				= "下一次小怪到來"
L.AUTO_TIMER_TEXTS.addsshort		= "小怪"
L.AUTO_TIMER_TEXTS.addscustom  		= "小怪到來(%%s)"
...
L.AUTO_ARROW_OPTION_TEXT			= "為跑向中了$spell:%s的目標顯示DBM箭頭"
L.AUTO_ARROW_OPTION_TEXT2		= "為離開中了$spell:%s的目標顯示DBM箭頭"
L.AUTO_ARROW_OPTION_TEXT3		= "為中了$spell:%s後移動到特定區域顯示DBM箭頭"
L.AUTO_VOICE_OPTION_TEXT			= "為$spell:%s播放語音音效"
L.AUTO_VOICE2_OPTION_TEXT		= "為階段轉換播放語音音效"
L.AUTO_VOICE3_OPTION_TEXT		= "為到來的小怪播放語音音效"
L.AUTO_VOICE4_OPTION_TEXT		= "為地上危險的技能播放語音音效"
L.AUTO_COUNTDOWN_OPTION_TEXT		= "為$spell:%s的冷卻播放倒數計時音效"
L.AUTO_COUNTDOWN_OPTION_TEXT2	= "為$spell:%s的減益播放倒數計時音效"
L.AUTO_COUNTOUT_OPTION_TEXT		= "為$spell:%s的持續時間播放倒數計時音效"
...
L.AUTO_YELL_OPTION_TEXT.iconfade	= "當$spell:%s正消退時大喊(倒數和圖示)"
L.AUTO_YELL_OPTION_TEXT.position	= "當你中了$spell:%s時大喊(位置)"
L.AUTO_YELL_OPTION_TEXT.combo	= "當你同時中了$spell:%s和其他技能時大喊(自訂文字)"
...
L.AUTO_YELL_ANNOUNCE_TEXT.fade	= "%s在%%d秒後消退!"
L.AUTO_YELL_ANNOUNCE_TEXT.shortfade	= "%%d"
L.AUTO_YELL_ANNOUNCE_TEXT.iconfade	= "{rt%%2$d}%%1$d"
L.AUTO_YELL_ANNOUNCE_TEXT.position = "{rt%%d}"..UnitName("player").."{rt%%d}中了%s(%%s)"--Arg order is going to be a problem. any way to word differently for playername at end?
L.AUTO_YELL_ANNOUNCE_TEXT.combo	= "%s和%%s"
...
L.AUTO_YELL_CUSTOM_FADE			= "%s消退了"
L.AUTO_HUD_OPTION_TEXT			= "為$spell:%s顯示HudMap(已退役)"
L.AUTO_HUD_OPTION_TEXT_MULTI		= "為不同的機制顯示HudMap(已退役)"
L.AUTO_NAMEPLATE_OPTION_TEXT		= "為$spell:%s顯示名條光環"
...
L.MOVE_WARNING_MESSAGE		= "感謝您使用Deadly Boss Mods"
...
L.ARROW_WAY_USAGE					= "/dway <x> <y>: 建立一個箭頭來指向特定位置(使用區域地圖坐標)"
L.ARROW_WAY_SUCCESS				= "要隱藏箭頭, 輸入 '/dbm arrow hide' 或是抵達箭頭"
L.ARROW_ERROR_USAGE	= {
	"DBM-Arrow 用法:",
	"-----------------",
...
L.DUR_HEADER					= "Deadly Boss Mods - 裝備耐久度結果"
