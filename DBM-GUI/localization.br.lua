...
L.StripTimerText			= "Strip recarga/próximo fora de cronômetroes"
L.KeepBar					= "Mantenha o cronômetro ativo até a habilidade ser lançada"
L.KeepBar2					= "(quando suportado pelo mod)"
L.FadeBar					= "cronômetroes de desbotamento para habilidades fora do alcance"
...
L.SpamBlockNoShowTimers		= "Não Exibir cronômetroes de modificação (Mod do Chefe/Respawn)"
L.SpamBlockNoShowUTimers	= "Não Exibir cronômetroes enviados pelo usuário (Personalizado/Puxar/Quebrar)"
...
L.StripServerName			= "Tira com nome do reino em avisos e cronômetroes"
